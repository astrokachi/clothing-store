		...
		<div className="home">
			...
			<div className="hero">
				<div className="hero__text">
					<h1 className="hero__header">Design Your Comfort Zone</h1>
			...
			<div className="mid">
				<div className="mid__back"></div>
				<div className="mid__header">
					<div className="mid__left">Custom Furniture built only for you.</div>
			...
			<div className="footer">
				<div className="footer__text">
					<p className="footer__header">Join our newsletter and get 20% off!</p>
					<p className="footer__helper">
